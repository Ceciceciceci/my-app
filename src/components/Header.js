                ...
                if (navItem.name === "header"){
                    return(
                        <ul className="nav-links" key={navItem.id}>
                            ...
                            <li><a href="https://ceciceciceci.github.io/#about">about</a></li>
                            <li><Link to="https://ceciceciceci.github.io/projects">projects</Link></li>
                            <li><a href="https://ceciceciceci.github.io/artindex.html">art</a></li>
                            <li><Link to="https://ceciceciceci.github.io/contact">contact</Link></li>
                        </ul>
                    )
                }
            })
